            ...
            <div className="text-white space-y-6">
              ...
              <div>
                <p className="text-lg md:text-xl font-lora opacity-90">
                  Bring a smile to coworker's face by sending
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-20 space-y-20">
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Message 1: Low bar - specific act */}
              <MessageCard
                senderName="Jessica Martinez"
                senderCharacter="🌸"
                messageEmoji="🙏"
                totalSmiles={12}
                message="Thank you for covering for me in that meeting, I would have been fired without you."
                recipientEmail="alex@example.com"
                recipientName="Alex"
              />

              {/* Message 2: High bar - enduring characteristic */}
              <MessageCard
                senderName="Priya Patel"
                senderCharacter="🎨"
                messageEmoji="⚡"
                totalSmiles={45}
                message="You are one of my favorite people to brainstorm with - you always have good energy and ideas."
          ...
          <div id="progress-section" className="space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 font-poppins">
              Mission: Create 1 trillion smiles at work, one at a time.
            </h2>
            <p className="text-xl text-gray-600 mb-8 font-lora">
              Send smiles to people you care about, and join the
              movement to make the workplace a little brighter.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="h-4 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min(globalProgress * 1000, 100)}%`,
                      }}
                    />
                  </div>
                  <p className="text-sm text-gray-600">
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">
                      {COMPANY_SMILES} {COMPANY_NAME} smiles
                    </h3>
                    <p className="text-sm text-gray-600">
                      from {COMPANY_NAME} employees
                    </p>
                  </div>
                </div>
                <div className="space-y-2">
                  {TOP_SENDERS.slice(0, 3).map(
                    (sender, index) => (
                      <div
                        key={sender.name}
                        className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-orange-50 to-pink-50"
            ...
            <div className="space-y-3">
              {TOP_COMPANIES.map((company, index) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-gray-900 text-lg truncate font-poppins">
                      {company.name}
                    </div>
            ...
            <div className="mt-6 p-4 bg-orange-50 rounded-xl border border-orange-200">
              <p className="text-sm text-gray-700 text-left font-lora">
                ...
                <span className="font-semibold">
                  Share this with friends at other companies to
                  make their work day a little bright, too!
                </span>
              </p>
            </div>
          </div>
